...
operations = [
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS session_recording_events_mv ON CLUSTER '{CLICKHOUSE_CLUSTER}'"),
    run_sql_with_exceptions(f"DROP TABLE IF EXISTS kafka_session_recording_events ON CLUSTER '{CLICKHOUSE_CLUSTER}'"),
